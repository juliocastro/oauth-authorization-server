package com.juliocastro.auth.config;
...
import com.juliocastro.auth.config.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
	...
	private void createJulioCastroRealm() {
		KeycloakSession session = getSessionFactory().create();
